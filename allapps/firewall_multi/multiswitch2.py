...
class MultiswitchApp2(frenetic.App):
  ...
  def switch_up(self, switch_id, ports):
    self.nib.set_all_ports( switch_id , ports )
  ...
  def policy(self):
    return IfThenElse((IPProtoEq(6) & IP4SrcEq("10.0.0.1") & IP4DstEq("10.0.0.3") & TCPDstPortEq(80) & EthTypeEq(0x800)),drop,self.policy_for_core_switch() | self.policy_for_edge_switches())#return self.policy_for_core_switch() | self.policy_for_edge_switches()
