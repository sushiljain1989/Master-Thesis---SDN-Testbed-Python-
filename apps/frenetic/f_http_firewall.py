...
class LearningApp3(frenetic.App):
  ...
  def connected(self):
    logging.info("Connected to Frenetic controller ")
  ...
  def policy(self):
    return \
      IfThenElse((IPProtoEq(6) & IP4SrcEq("10.0.0.1") & IP4DstEq("10.0.0.2") & TCPDstPortEq(80) & EthTypeEq(0x800)),drop,IfThenElse(
